...
@section('subtitle')
    <b>Módulo:</b> {{ $perfil->modulo->nome }} | <b>Perfil:</b> {{ $perfil->nome }}
@stop
...
@section('content')
    <div class="box box-primary">
        <div class="box-header">
            ...
            <br>
            {!! Form::open(["url" => "/seguranca/perfis/atribuirpermissoes/". $perfil->id, "method" => "POST", "role" => "form"]) !!}
                {!! Form::hidden('permissao','' , ['id'=>'permissao']) !!}
                {!! Form::hidden('prf_id', $perfil->prf_id) !!}
                <div class="row">
                    <div class="form-group col-md-12">
                        {!! Form::submit('Atribuir permissões ao perfil', ['class' => 'btn btn-primary pull-left', 'id' => 'btn-enviar']) !!}
                    </div>
                </div>
            {!! Form::close() !!}
        </div>
